...
public class UserController {
    ...
    public ResponseEntity<String> updateRole(@PathVariable Long id,
        ...
        // ✅ Validate: role chỉ có thể là USER hoặc ADMIN
        if (!role.equals("USER") && !role.equals("ADMIN")) {
            throw new RuntimeException("Role không hợp lệ! Chỉ được phép 'USER' hoặc 'ADMIN'");
        }
        ...
        return ResponseEntity.ok("Cập nhật role thành công: " + user.getUsername() + " -> " + role);
    }
}